...
async function get_char_info(char_id) {
...
let favorites = await request_json("/get_favoriet", "", "GET", "id");
if (!karakterID) {
    alert('Geen karakter geselecteerd!');
    window.location.href = 'personages.html';
}
console.log(karakterID);
async function fill_character_page(char_id) {
    let char = await get_char_info(char_id);
    console.log(char);
